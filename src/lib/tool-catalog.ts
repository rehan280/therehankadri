...
export const toolCatalog: ToolDefinition[] = [
  ...
  },
  {
    ...
    kind: "existing",
    shortDescription: "Fetch comments from a video and pick a random winner for giveaways.",
    intro: "A premium, animated picker to draw a random winner from any public YouTube video.",
