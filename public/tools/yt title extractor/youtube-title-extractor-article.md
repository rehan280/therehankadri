# YouTube Title Extractor Tool (Free)
...
1. Pull the top 20-30 ranking video URLs for your target keyword
2. Run each URL through this tool
3. Download each result as a .txt file
4. Drop everything into a spreadsheet
...
**Does it extract more than just the title?**
...
**Why would I need to extract a YouTube title?**
...
**Can I extract titles from a full YouTube channel?**
...
**Do YouTube titles affect Google search rankings too?**
...
## Now go extract your first title
