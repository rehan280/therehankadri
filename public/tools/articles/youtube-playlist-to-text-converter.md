You've got a YouTube playlist. Now you want it in a usable format — a numbered list, a clean text doc, a CSV you can drop into a spreadsheet.

Copy-pasting from YouTube into a doc manually is painful. Formatting breaks. Numbers don't align. Video metadata doesn't transfer cleanly. You spend 10 minutes cleaning up what should have taken 30 seconds.
...
**Can I add additional columns in CSV mode?**
...
**What if the playlist is private or unlisted?**
...
**Does the output include video durations?**
