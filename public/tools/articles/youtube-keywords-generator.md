Keyword research is how you make sure your videos get found. Not just seen - found. By people who are actively looking for exactly what you're covering.
...
1. Search the exact term on YouTube
2. Look at the view count on the top 5 results
3. Check the channel sizes of those top 5 results (are they all channels with 1M+ subscribers?)
4. Look at the upload dates (are the top results from 2020 or 2024?)
...
**Should I optimize every video for a specific keyword?**
...
**How does YouTube's keyword system differ from Google's?**
...
1. Enter your 3 core sub-topics into this tool one at a time.
2. From each run, save the 5-8 keywords that best match your audience and filming capability.
3. Validate each keyword with a YouTube search.
4. Eliminate any keyword where the top results are from channels with 500K+ subscribers AND the videos are less than 1 year old.
5. What's left is your content calendar.
